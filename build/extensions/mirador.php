...
END;
	...
	$d = positionExtraContent ($d, '<div class="row" style="padding-left:16px;padding-right:16px;"><div class="col-12 col-lg-12"><div style="height:800px;position:relative;width: 90%; min-width:324px;" id="mirador"></div></div></div>'.$codeHTML);
